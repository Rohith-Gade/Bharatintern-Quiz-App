...
import com.example.root.quiz_app.DbHelper;
import com.example.root.quiz_app.Question;
import com.example.root.quiz_app.R;

import java.util.List;

public class MainActivityStage2 extends AppCompatActivity
{
                ...
                if(grp!=null) {
                    ...
                    if (answer!=null) {
                        ...
                        if (qid < qid_final) {
                            ...
                            q_no=1;
                            Intent intent = new Intent(MainActivityStage2.this, ResultActivityStage2.class);
                            Bundle b = new Bundle();
                        ...
                        Toast.makeText(MainActivityStage2.this, "Please Select Option", Toast.LENGTH_SHORT).show();
                    }
                }else {
                    Toast.makeText(MainActivityStage2.this, "Please Select Option", Toast.LENGTH_SHORT).show();
                }
